# Generated by Django 2.1.4 on 2018-12-31 07:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('common', '0002_auto_20181230_1631'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.IntegerField(default=None, null=True, verbose_name='Duration')),
                ('priority', models.CharField(blank=True, max_length=10)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='Created on')),
                ('description', models.TextField(blank=True, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('assigned_to', models.ManyToManyField(blank=True, related_name='event_assigned_user', to=settings.AUTH_USER_MODEL)),
